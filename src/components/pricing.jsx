...
const Pricing = () => {
    ...
    const paskages = [
        {nmae: "Start", monthlyPrice: 19, yearlyPrice: 199, description: "A common form of Lorem ipsum reads: Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
        green: "/src/assets/Rectangle 18.png"},
        {nmae: "Advance", monthlyPrice: 39, yearlyPrice: 399, description: "A common form of Lorem ipsum reads: Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
        green: "/src/assets/Rectangle 18.png"},
        {nmae: "Premium", monthlyPrice: 59, yearlyPrice: 599, description: "A common form of Lorem ipsum reads: Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
        green: "/src/assets/Rectangle 18.png"},
    ]

  return (
    <div className="md:px-40 p-4 max-w-s mx-auto py-10" id="pricing">
        ...
        className="grid sm:grid-cols-2 lg:grid-cols-3 gap-10 mt-20 md:w-11/12 mx-auto">
            {
                paskages.map((pkg, index) => <div key={index} className="border py-10 md:px-6 px-4 rounded-lg shadow-3xl">
                    <h3 className="text-3xl text-center font-bold text-primary">{pkg.nmae}</h3>
